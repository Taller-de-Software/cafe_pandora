...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        errorElement: <RouteError />,
        children: [
          { index: true, element: <RoleGuard allowedRoles={['administrador']} fallback="/dashboard/pedidos"><Inicio /></RoleGuard>, errorElement: <RouteError /> },
          { path: 'inicio', element: <RoleGuard allowedRoles={['administrador']} fallback="/dashboard/pedidos"><Inicio /></RoleGuard>, errorElement: <RouteError /> },
          ...
          { path: 'caja-finanzas', element: <RoleGuard allowedRoles={['administrador']} fallback="/dashboard/pedidos"><CajaFinanzas /></RoleGuard>, errorElement: <RouteError /> },
