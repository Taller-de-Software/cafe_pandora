      ...
      <div className={styles.body}>
        <div className={styles.grid}>
          <div className={styles.stat}>
            ...
            <span className={`${styles.statValue} ${styles.statExito}`}>${formatearNumero(resumen.sumaTotal)}</span>
          </div>
          <div className={styles.stat}>
          ...
          <div className={styles.stat}>
            ...
            <span className={`${styles.statValue} ${styles.statOro}`}>${formatearNumero(sesion.totalEnCaja)}</span>
          </div>
          <div className={styles.stat}>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.retiroGrid}>
              <div className={styles.retiroStat}>
                ...
                <span className={`${styles.retiroValor} ${styles.entrada}`}>${formatearNumero(resumen.totalEntradasRetiros)}</span>
              </div>
              <div className={styles.retiroStat}>
                <span className={styles.retiroLabel}>Salidas</span>
                <span className={`${styles.retiroValor} ${styles.salida}`}>${formatearNumero(resumen.totalSalidasRetiros)}</span>
              </div>
            </div>
