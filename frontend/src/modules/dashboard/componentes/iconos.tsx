import type { IconoNombre } from '../data/navegacion'
...
const svgPaths: Record<IconoNombre, string> = {
  ...
  hamburguesa: 'M4 6h16M4 12h16M4 18h16',
...
function Icono({ name, className }: IconoProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={svgPaths[name]} />
    </svg>
  )
}
