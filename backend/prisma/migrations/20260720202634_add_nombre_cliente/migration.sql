...
INSERT INTO "new_pedidos" ("canceladoEn", "creadoEn", "estado", "fechaPago", "finalizadoEn", "hechoEn", "id", "mesaId", "mesaOrigenId", "pendienteEn", "total", "totalAbonado", "turno", "usuarioId") SELECT "canceladoEn", "creadoEn", "estado", "fechaPago", "finalizadoEn", "hechoEn", "id", "mesaId", "mesaOrigenId", "pendienteEn", "total", "totalAbonado", "turno", "usuarioId" FROM "pedidos";
DROP TABLE "pedidos";
